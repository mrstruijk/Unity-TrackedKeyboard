...
namespace Meta.XR.TrackedKeyboardSample
{
    ...
    public class KeyboardInteractionManager : MonoBehaviour
    {
        ...
        private int GetHandIndex(OVRHand hand)
        {
            return hand.GetHand() == OVRPlugin.Hand.HandLeft ? 0 : 1;
        }
        ...
        {
            var ovrHand = other.GetComponentInChildren<OVRHand>();
            ...
            var handIndex = GetHandIndex(ovrHand);
        ...
        {
            var ovrHand = handCollider.GetComponentInChildren<OVRHand>();
            ...
            var handIndex = GetHandIndex(ovrHand);
            var penetrationDistance = CalculatePenetrationDistance(handCollider);
        ...
        {
            var shouldHover = _handStates[LeftHandIndex].IsHovering || _handStates[RightHandIndex].IsHovering;
